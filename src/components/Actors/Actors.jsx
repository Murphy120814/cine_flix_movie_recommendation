...
import { useGetActorsDetailQuery, useGetMoviesByActorIdQuery } from '../../services/TMDB';
  ...
  return (
    <>
      <Grid container spacing={3}>
        <Grid item lg={5} xl={4}>
          <img className={classes.image} alt={data.name} src={`https://image.tmdb.org/t/p/w780/${data?.profile_path}`} />
        </Grid>
        <Grid item lg={7} xl={8} style={{ display: 'flex', justifyContent: 'center', flexDirection: 'column' }}>
          ...
          <Box marginTop="2rem" display="flex" justifyContent="space-around">
            ...
            {/* <Button startIcon={<ArrowBack />} href="/" color="primary">Back</Button> */}
          </Box>
        </Grid>
      </Grid>
      <Box margin="2rem 0">
